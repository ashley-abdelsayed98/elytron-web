...
public abstract class ExternalAuthenticationBase extends AbstractHttpServerMechanismTest {
    ...
    protected SecurityDomain doCreateSecurityDomain() throws Exception {
        ...
        passwordMap.put("remoteUser", new SimpleRealmEntry(Collections.singletonList(new PasswordCredential(passwordFactory.generatePassword(new ClearPasswordSpec("doesntmatter".toCharArray()))))));
